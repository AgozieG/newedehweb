...
const GalleryImages = () => {
  ...
  const images = [
    { src: './n2.jpg', category: 'Event' },
    { src: './m7.jpg', category: 'Me' },
    { src: './q4.jpg', category: 'Event' },
    { src: './e3.jpg', category: 'Academic' },
    ...
    { src: './m9.jpg', category: 'Event' },
    { src: './m3.jpg', category: 'Event' },
    { src: './s2.jpg', category: 'Me' },
    { src: './faveicon.jpg', category: 'Me' },
    { src: './a6.jpg', category: 'Academic' },
    { src: './b9.jpg', category: 'Event' },
    { src: './s3.jpg', category: 'Media' },
    { src: './x6.jpg', category: 'Academic' },
    { src: './x2.jpg', category: 'Academic' },
    { src: './sit.jpg', category: 'Training' },
    { src: './t6.jpg', category: 'Event' },
    { src: './s1.jpg', category: 'Academic' },
    { src: './a1.jpg', category: 'Army' },
    { src: './a5.jpg', category: 'Army' },
    { src: './a8.jpg', category: 'Academic' },
    { src: './a7.jpg', category: 'Teaching' },
    { src: './a2.jpg', category: 'Army' },
    { src: './a3.jpg', category: 'Army' },
    { src: './about1.jpg', category: 'Me'},
    { src: './s13.jpg', category: 'Me' },
    { src: './s14.jpg', category: 'Me' },
    { src: './s15.jpg', category: 'Me' },
    { src: './n6.jpg', category: 'Army' },
    { src: './quality.png', category: 'Me' },
    { src: './bg2.jpg', category: 'Me' },
    { src: './cap.jpg', category: 'Event' },
  ]
